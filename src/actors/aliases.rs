...
use crate::pb::mpc::KeygenRequest;
...
pub(crate) type ProtocolOutputKG = ProtocolOutput<KeygenRequest, LocalKey<Secp256k1>>;
...
pub(crate) type MpcPlayerKG = MpcPlayer<KeygenRequest, Keygen, <Keygen as StateMachine>::MessageBody, <Keygen as StateMachine>::Err, <Keygen as StateMachine>::Output>;
